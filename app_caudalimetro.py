...
# 2. CSS MAESTRO (SOLUCIÓN DEFINITIVA AL DESPLAZAMIENTO)
st.markdown("""
    <style>
    ...
    /* --- 2. CAPA CENTRAL NEGRA (FONDO DEL SIMULADOR) --- */
    /* Se mantiene fija en el centro exacto de la pantalla */
    ...
    /* --- 3. BLOQUEO DE MOVIMIENTO (SIDEBAR OVERLAY) --- */
    /* Esto hace que la barra lateral flote sobre el contenido sin empujarlo */
    ...
    /* Anulamos el margen dinámico que Streamlit aplica al contenido cuando se abre el sidebar */
    ...
    /* --- 4. CONTENEDOR DE CONTENIDO (BLOQUEADO AL CENTRO) --- */
    [data-testid="stAppViewBlockContainer"] {
        max-width: 1100px !important;
        margin: 0 auto !important;
        padding-top: 130px !important;
        z-index: 1;
        /* Forzamos a que no responda al sidebar */
        left: 0 !important; 
    }

    /* --- 5. BOTÓN DE DESPLIEGUE (NEÓN) --- */
...
with st.sidebar:
    ...
    st.info("💡 Haz clic en la flecha azul para cerrar este panel.")
...
if st.button('🚀 Generar curva de calibración'):
    ...
    V_mv = (B_si * D_si * v * 1000) # Simplificado para estabilidad
